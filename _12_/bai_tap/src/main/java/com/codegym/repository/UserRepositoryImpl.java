...
public class UserRepositoryImpl implements IUserRepository {
    ...
    private static final String FIND_BY_CONTRY = "SELECT * FROM users where country like ? ";
    ...
    public List<User> findByCountry(String countryS) {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_BY_CONTRY);
